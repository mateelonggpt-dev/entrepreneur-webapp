...
ALLOWED_TRANSITIONS: dict[str, list[str]] = {
    ...
    "receipt": ["credit_note"],
    "purchase_order": ["goods_receive", "receive_inventory", "vendor_invoice", "expense", "supplier_payment"],
    "goods_receive": ["vendor_invoice", "expense", "supplier_payment"],
    "receive_inventory": ["vendor_invoice", "expense", "supplier_payment"],
    "vendor_invoice": ["supplier_payment", "withholding_tax_certificate", "credit_note_from_vendor", "debit_note_from_vendor"],
    "expense": ["supplier_payment", "withholding_tax_certificate"],
