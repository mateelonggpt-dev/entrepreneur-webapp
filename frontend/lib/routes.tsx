...
import SalesInvoices from "@/views/sales/SalesInvoices";
...
import Receipts from "@/views/sales/Receipts";
import Billing from "@/views/sales/Billing";
import CreditNotes from "@/views/sales/CreditNotes";
import DebitNotes from "@/views/sales/DebitNotes";
...
import GoodsReceived from "@/views/purchases/GoodsReceived";
import Expenses from "@/views/purchases/Expenses";
